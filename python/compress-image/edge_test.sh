...
curl http://localhost:3000/ -H "X-Internal-Challenge: secret-key" -H "Content-Type: application/json" -d '{"payload": {"provider": "krakenio", "image": "1234" }, "variables": { "API_KEY": {f66cec6f44df73d3ba48d8dbce302738}, "SECRET_API_KEY":"7bbd29dd53c00a068b7ebe20b074540a0d7cea9d"} }'
printf '\n'
